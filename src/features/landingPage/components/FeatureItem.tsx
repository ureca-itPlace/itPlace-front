    ...
    >
      ...
      <div className="flex flex-col justify-center text-white text-left w-[40%] h-full pt-0 gap-12 px-12 max-lg:text-center max-lg:px-2 max-lg:w-full max-lg:h-fit max-lg:pt-4 max-lg:gap-6">
        ...
        <div className="flex flex-col gap-8">
          ...
          <p className="feature-desc text-2xl font-light leading-loose max-xl:text-xl max-xl:leading-loose max-lg:leading-loose max-md:leading-relaxed max-sm:leading-relaxed">
            {description}
          </p>
        </div>
      </div>
