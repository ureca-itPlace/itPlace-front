...
import NoCouponTopImg from '/images/event/empty-box.png';
    ...
    <>
      ...
      >
        <div className="flex flex-col items-center text-center">
          <div className="absolute -top-[220px] left-1/2 -translate-x-1/2 w-[380px] h-[292px] max-sm:-top-[110px] max-sm:w-[220px] max-sm:h-[150px] max-md:w-[290px] max-md:h-[200px] max-md:-top-[190px] max-xl:w-[250px] max-xl:h-[180px] max-xl:-top-[130px]">
            <img
              src={NoCouponTopImg}
              alt="당첨 일러스트"
