    ...
    <>
      ...
      >
        <div className="relative w-full flex flex-col items-center text-center pt-10">
          <div className="absolute -top-[150%] left-1/2 -translate-x-1/2 w-[380px] h-[292px] max-sm:-top-[130px] max-sm:w-[150px] max-sm:h-[150px]">
          ...
          <p className="text-body-0 text-[#000000] mt-8 max-sm:text-body-2 max-sm:mt-4">
            다음 기회를 노려보세요😢
            <br />
            잇플을 이용해주셔서 감사합니다!
          </p>
