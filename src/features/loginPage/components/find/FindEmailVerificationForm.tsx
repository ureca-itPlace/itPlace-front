      ...
      <div className="w-[320px] max-xl:w-[274px] max-lg:w-[205px] mt-[48px] max-xl:mt-[41px] max-lg:mt-[32px]">
        <div className="flex items-center relative">
          ...
          <button
            ...
            disabled={loading}
            className="absolute right-[12px] max-xl:right-[10px] max-lg:right-[8px] w-[69px] max-xl:w-[59px] max-lg:w-[44px] h-[26px] max-xl:h-[22px] max-lg:h-[17px] bg-purple04 text-white text-body-4 max-xl:text-body-5 max-lg:text-body-5 rounded-[10px] max-xl:rounded-[9px] max-lg:rounded-[7px] flex items-center justify-center"
          >
            {loading ? (
