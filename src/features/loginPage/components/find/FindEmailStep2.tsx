...
const FindEmailStep2 = ({
  ...
  return (
    ...
    >
      ...
      {/* 이메일 및 가입일 박스 */}
      <div className="w-[320px] max-xl:w-[274px] max-lg:w-[205px] max-md:w-[280px] max-sm:w-full h-[90px] max-xl:h-[77px] max-lg:h-[61px] max-md:h-[70px] max-sm:h-[80px] bg-white border border-grey03 rounded-[18px] max-xl:rounded-[15px] max-lg:rounded-[12px] max-md:rounded-[14px] max-sm:rounded-[16px] px-[20px] max-xl:px-[17px] max-lg:px-[13px] max-md:px-[15px] max-sm:px-[16px] py-[16px] max-xl:py-[14px] max-lg:py-[11px] max-md:py-[12px] max-sm:py-[14px] text-left mt-[20px] max-xl:mt-[17px] max-lg:mt-[13px] max-md:mt-[15px] max-sm:mt-[16px] flex flex-col justify-center">
