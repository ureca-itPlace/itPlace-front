...
export const mockFavorites: FavoriteItem[] = [
  ...
  { benefitId: 43, benefitName: 'GS25', image: '/images/mock/gs25.png' }, // 등급별로 다른 혜택 예시
  { benefitId: 5, benefitName: '투루카', image: '/images/mock/turucar.png' }, // VIP 콕 예시
  { benefitId: 31, benefitName: 'CGV', image: '/images/mock/cgv.png' }, // 모든등급 같은 혜택 예시
];
