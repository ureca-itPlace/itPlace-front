...
export default function SideMenu() {
  return (
    <>
      {/* ✅ 데스크탑용 사이드 메뉴*/}
      <aside className="w-full max-w-[370px] bg-white rounded-[18px] drop-shadow-basic pt-[76px] pb-[56px] px-3 max-xl:max-w-[310px] max-xl:pt-[56px] max-xlg:max-w-[220px] max-xlg:min-w-[180px] max-xlg:pt-[36px] max-md:hidden">
